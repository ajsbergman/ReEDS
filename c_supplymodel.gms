...
* add domestic byproduct recovery (without the specific material(s) being restricted)
    + (Sw_byproduct_multiplier_usa * sum{mat_ctry$[usa(mat_ctry)$(not sameas(mat,'%GSw_specmat%'))], mat_byproduct(mat,mat_ctry)} * yearweight(t))$Sw_byproduct
* add domestic reserves (without the specific material(s) being restricted)
    + (Sw_reserve_multiplier_usa * sum{mat_ctry$[usa(mat_ctry)$(not sameas(mat,'%GSw_specmat%'))], mat_reserve(mat,mat_ctry)} * yearweight(t))$Sw_reserve
...
* add global production outside US (without the specific material(s) being restricted)
    + (sum{mat_ctry$[(not usa(mat_ctry))$(not sameas(mat,'%GSw_specmat%'))], mat_prod(mat,mat_ctry)} * yearweight(t))$Sw_mat_glb
* add global production outside US without china
