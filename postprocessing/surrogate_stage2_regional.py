"""
Stage 2: Extract X (design inputs) and Y (regionally-resolved 2050 outputs) from ReEDS surrogate runs.
...
Usage:
    python surrogate_stage2_regional.py --runs_dir /path/to/runs --output stage2_ml.csv
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Stage 2: Extract regionally-resolved 2050 outputs from ReEDS surrogate runs."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output", type=str, default="surrogate_ml_data/stage2_regional_ml.csv",
